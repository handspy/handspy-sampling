...
/**
 * Criteria class for the {@link pt.up.hs.sampling.domain.Device} entity. This class is used
 * in {@link pt.up.hs.sampling.web.rest.DeviceResource} to receive all the possible filtering options from
...
public class DeviceCriteria implements Serializable, Criteria {
    ...
    private DeviceTypeFilter type;

    private StringFilter plugin;
    ...
    public DeviceCriteria(DeviceCriteria other) {
        ...
        this.plugin = other.plugin == null ? null : other.plugin.copy();
    }
    ...
    public DeviceTypeFilter getType() {
        return type;
    }

    public void setType(DeviceTypeFilter type) {
        this.type = type;
    }

    public StringFilter getPlugin() {
        return plugin;
    }

    public void setPlugin(StringFilter plugin) {
        this.plugin = plugin;
    }
